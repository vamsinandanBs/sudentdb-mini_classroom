                ...
                <main>
                            ...
                            <div class="container text-center">
                                <div class="row justify-content-center">
                                    <div class="col-lg-8">
                                        ...
                                        <p class="page-header-text">ask-/-post</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section class="bg-white py-10">
                        <div class="container">
                            <div>
                                <h1>about us.</h1>
                                <p class="lead">this is  DBMS mini project </p>
                                <p>project did by:-</p>
                                <p>Vamsinandan BS.(1CE18CS095) </p>
                                <p>Pramod BS.(1CE18CS056) </p>
                                <p>Guided By: Archana Bhat mam</p>
                            </div>
