<?php $current_page = "Privacy Policy"; ?>
                        ...
                        <div class="page-header-content pt-10">
                            <div class="container text-center">
                                <div class="row justify-content-center">
                                    <div class="col-lg-8">
                                        <h1 class="page-header-title mb-3">Studentdb</h1>
                    ...
                    <section class="bg-white py-10">
                        <div class="container">
                            <div>
                                ...
                                <p class="lead">this is our dbms project!</p>
                                <p>project did by :-</p>
                                <p>Vamsinandan BS(city engineering college).</p>
                                <p>Pramod BS(city engineering college).</p>
                            </div>
                ...
                <footer class="footer pt-4 pb-4 mt-auto bg-dark footer-dark">
                    <div class="container">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6 small">Copyright &#xA9; studentdb 2020</div>
                            <div class="col-md-6 text-md-right small">
                                <a href="Privacy-Policy.php">Privacy-Policy.php</a>
                                &#xB7;
